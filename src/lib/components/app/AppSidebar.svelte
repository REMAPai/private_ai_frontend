<script lang="ts">
	...
	import ChatItem from '../layout/Sidebar/ChatItem.svelte';
	import Spinner from '../common/Spinner.svelte';
	import Loader from '../common/Loader.svelte';
	import Folder from '../common/Folder.svelte';
	import Tooltip from '../common/Tooltip.svelte';
	import Folders from '../layout/Sidebar/Folders.svelte';
	import { getChannels, createNewChannel } from '$lib/apis/channels';
	import ChannelModal from '../layout/Sidebar/ChannelModal.svelte';
	import ChannelItem from '../layout/Sidebar/ChannelItem.svelte';
	import PencilSquare from '../icons/PencilSquare.svelte';
	import Search from '../icons/Search.svelte';
	import SearchModal from '../layout/SearchModal.svelte';
	import FolderModal from '../layout/Sidebar/Folders/FolderModal.svelte';
	import Sidebar from '../icons/Sidebar.svelte';
	import PinnedModelList from '../layout/Sidebar/PinnedModelList.svelte';
